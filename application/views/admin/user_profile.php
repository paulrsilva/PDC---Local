...
<div id="page-content">
    ...
    <div class="content-header content-header-media">
        <div class="header-section">
            <img src="<?php echo base_url(); ?>images/placeholders/avatars/avatar2.jpg" alt="Avatar" class="pull-right img-circle">
            <h1>John Doe <br><small>Life Explorer &amp; Traveller</small></h1>
        </div>
        <!-- For best results use an image with a resolution of 2560x248 pixels (You can also use a blurred image with ratio 10:1 - eg: 1000x100 pixels - it will adjust and look great!) -->
        <img src="<?php echo base_url(); ?>images/placeholders/headers/profile_header.jpg" alt="header image" class="animation-pulseSlow">
    </div>
                    ...
                    <ul class="media-list media-feed media-feed-hover">
                        ...
                        <li id="newsfeed-update-example" class="media display-none">
                            <a href="page_ready_user_profile.php" class="pull-left">
                                <img src="images/placeholders/avatars/avatar<?php echo rand(1, 16); ?>.jpg" alt="Avatar" class="img-circle">
                            </a>
                            <div class="media-body">
                                ...
                                <div class="row push">
                                    <div class="col-sm-6 col-md-4">
                                        <a href="images/placeholders/photos/photo13.jpg" data-toggle="lightbox-image">
                        ...
                        <li class="media">
                            ...
                            <div class="media-body">
                                ...
                                <ul class="media-list push">
                                    ...
                                    <li class="media">
                                        <a href="page_ready_user_profile.php" class="pull-left">
                                            <img src="images/placeholders/avatars/avatar2.jpg" alt="Avatar" class="img-circle">
                                        </a>
                                        <div class="media-body">
                                            <a href="page_ready_user_profile.php"><strong>User</strong></a>
                                    ...
                                    <li class="media">
                                        <a href="page_ready_user_profile.php" class="pull-left">
                                            <img src="images/placeholders/avatars/avatar.jpg" alt="Avatar" class="img-circle">
                                        </a>
                                        <div class="media-body">
                ...
                <div class="gallery" data-toggle="lightbox-gallery">
                    <div class="row">
                        <div class="col-xs-6 col-sm-3">
                            <a href="images/placeholders/photos/phot12.jpg" class="gallery-link" title="Image Info">
                                <img src="images/placeholders/photos/photo12.jpg" alt="image">
                            </a>
                        </div>
                        <div class="col-xs-6 col-sm-3">
                        ...
                        <div class="col-xs-6 col-sm-3">
                            <a href="images/placeholders/photos/photo3.jpg" class="gallery-link" title="Image Info">
                                <img src="images/placeholders/photos/photo3.jpg" alt="image">
                            </a>
                        </div>
                        <div class="col-xs-6 col-sm-3">
                            <a href="images/placeholders/photos/photo4.jpg" class="gallery-link" title="Image Info">
                                <img src="images/placeholders/photos/photo4.jpg" alt="image">
                            </a>
                        </div>
                        <div class="col-xs-6 col-sm-3">
                        ...
                        <div class="col-xs-6 col-sm-3">
                            <a href="images/placeholders/photos/photo20.jpg" class="gallery-link" title="Image Info">
                                <img src="images/placeholders/photos/photo20.jpg" alt="image">
                            </a>
                        </div>
                        <div class="col-xs-6 col-sm-3">
                            <a href="images/placeholders/photos/photo17.jpg" class="gallery-link" title="Image Info">
                                <img src="images/placeholders/photos/photo17.jpg" alt="image">
                            </a>
                        </div>
                        <div class="col-xs-6 col-sm-3">
                            <a href="images/placeholders/photos/photo14.jpg" class="gallery-link" title="Image Info">
                                <img src="images/placeholders/photos/photo14.jpg" alt="image">
                            </a>
                        </div>
                        <div class="col-xs-6 col-sm-3">
                            <a href="images/placeholders/photos/photo9.jpg" class="gallery-link" title="Image Info">
                                <img src="images/placeholders/photos/photo9.jpg" alt="image">
                            </a>
                        </div>
                        <div class="col-xs-6 col-sm-3">
                            <a href="images/placeholders/photos/photo11.jpg" class="gallery-link" title="Image Info">
                                <img src="images/placeholders/photos/photo11.jpg" alt="image">
                            </a>
                        </div>
                        <div class="col-xs-6 col-sm-3">
                            <a href="images/placeholders/photos/photo10.jpg" class="gallery-link" title="Image Info">
                                <img src="images/placeholders/photos/photo10.jpg" alt="image">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row text-center">
                    <div class="col-xs-4 col-sm-3 col-lg-2 block-section">
                        <a href="javascript:void(0)">
                            <img src="images/placeholders/avatars/avatar<?php echo rand(1, 16); ?>.jpg" alt="image" class="img-circle" data-toggle="tooltip" title="Username">
                        </a>
                    </div>
                    <div class="col-xs-4 col-sm-3 col-lg-2 block-section">
                        <a href="javascript:void(0)">
